...
<template>
  <!-- ---------------------------------------------- -->
  <!--- Sub Item in second navigation drawer -->
  <!-- ---------------------------------------------- -->
  <v-navigation-drawer

    v-model:mini-variant="customizer.mini_sidebar"
    class="rounded-r-xl"
    :class="customizer.darktheme ? 'on-surface-light' : 'on-surface-dark'"
    :color="customizer.darktheme ? 'on-surface-dark' : customizer.SidebarColor"
    :rail="false"

    :elevation=" (customizer.Sidebar_drawer && customizer.mini_sidebar) ? 2 : 0"
  >
    <!-- ---------------------------------------------- -->
    <!--- Navigation 2 -->
    <!-- ---------------------------------------------- -->
