...
const cards = ref([
  ...
  {
    color: 'warning',
    icon: 'i-feather-credit-card',
    title: '1800',
    subtitle: 'Total Budgets',
  },
  {
    color: 'blue',
    icon: 'i-feather-github',
    title: '90',
...
<template>
  ...
  <!-- ----------------------------------------------------------------------------- -->
  <v-row>
    <v-col v-for="(item, i) in cards" :key="i" cols="12" lg="4">
      <v-card>
        ...
        <v-card-text class="pa-6">
          ...
          <v-btn variant="flat" class="mt-4 text-white" :color="item.color">
            Go Somewhere
          </v-btn>
        </v-card-text>
      </v-card>
