      ...
      <div class="d-md-flex align-items-center">
        <perfect-scrollbar style="height: 550px">
          ...
          >
            <!-- Comment Row -->
            <div
              class="d-flex flex-row comment-row mt-0 pa-3"
            ...
            >
              ...
              <div class="comment-text w-100 pa-3">
                <div class="d-flex align-center">
                  ...
                  <v-chip
                    class="ml-2"
                    :color="comment.badgebg"
                    size="x-small"
                  >
                    {{ comment.status }}
                  </v-chip>
                </div>
                <span class="d-block my-2 text-subtitle-2 font-weight-regular">{{
                  comment.desc
                }}</span>
                <div class="d-flex">
                  <v-btn size="small" :color="comment.badgebg">
                    Read More
                  </v-btn>
                  <small class="text-muted ml-auto">{{ comment.date }}</small>
                </div>
              </div>
            </div>
          </div>
