    ...
    <v-card-text class="pa-5">
      <v-row justify="space-between">
        ...
        <v-col cols="12" lg="4" class="justify-end align-center d-flex">
          <v-dialog v-model="dialog" min-width="250px" transition="dialog-bottom-transition">
    ...
    >
      <v-card>
        <v-card-text class="pa-5 text-center">
          ...
          <h4 class="title h4 mt-3 mb-2">
            {{ contactgrid.contactname }}
          </h4>
          <span class="text-xs">{{ contactgrid.role }}</span>
          <div class="mt-3">
            <v-btn depressed small color="primary" class="mr-2">
              Chat
            </v-btn>
        ...
        <div
          ...
          "
        >
          <v-icon class="mr-2" icon="i-feather-phone" />
          {{ contactgrid.phone }}
        </div>
