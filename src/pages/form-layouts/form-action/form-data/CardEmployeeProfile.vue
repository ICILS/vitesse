...
<template>
  <div>
    ...
    >
      Form Action at Right ending of the form.
    </v-alert>
    <h6 class="text-subtitle-1 text-grey-darken-1">
      To use add form actions on bottom of the form add a div with .action-form
      class to begining the form.
    </h6>

    <v-card-text class="pa-3 mt-3">
      <h3 class="subtitle">
        About Employee
      </h3>
      ...
      <v-row class="mt-3">
        ...
        <v-col cols="12" sm="6" lg="6" class="pt-0">
          ...
          <v-text-field label="Nick Name" variant="outlined" />
        </v-col>
      </v-row>
    </v-card-text>
    <v-card-text class="pa-3">
      ...
      <v-row class="mt-3">
        ...
        <v-col class="12" sm="6" lg="6">
          <v-text-field label="Website" variant="outlined" />
        </v-col>
        <v-col cols="12">
