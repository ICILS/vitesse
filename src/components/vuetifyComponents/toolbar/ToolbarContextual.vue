    ...
    <div class="mt-6">
      <v-card max-width="500" class="mx-auto">
        <v-toolbar
          ...
          dark
        >
          <v-app-bar-nav-icon v-if="!selection.length" color="inherit" />
          <v-btn v-else icon color="inherit" @click="selection = []">
            <v-icon>i-mdi-close</v-icon>
          </v-btn>
          ...
          <v-scale-transition>
            <v-btn v-if="selection.length" key="export" color="inherit" icon>
              <v-icon>i-mdi-export-variant</v-icon>
            </v-btn>
          </v-scale-transition>
          <v-scale-transition>
            <v-btn v-if="selection.length" key="delete" color="inherit" icon>
              <v-icon>i-mdi-delete</v-icon>
            </v-btn>
          </v-scale-transition>

          <v-btn color="inherit" icon>
            <v-icon>i-mdi-dots-vertical</v-icon>
          </v-btn>
        </v-toolbar>
