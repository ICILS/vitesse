...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      Dividers and subheaders can help break up content and can optionally line
      up with one another by using the same <code>inset</code> prop.
