...
import HockeyDemo from '../../../components/HockeyDemo.vue'
import HockeyTeamList from '../../../components/HockeyTeamList.vue'
// import RadioGroup from '../../../components/HeadlessUI/RadioGroup.vue'
import people from './data/people'

const { t } = useI18n() // use as global scope
const task = ref({ title: t('task_4') })
// Item ID
const contentID = 'ModFloppyItemT4'
const nextTask = 'task-5'
// Use faker to generate random paragraphs
// const faker = require("faker/locale/en");
// const lorem = faker.lorem.paragraphs(2);
</script>
...
<template>
  <v-row dense>
    ...
    >
      <div class="pa-0">
        <!-- Item content card  -->
        <BaseQuestionContentCard :task-heading="task.title" :nav-next="nextTask">
          <v-card>
            <v-card-text class="pb-1 text-body-2">
              PLACEHOLDER
