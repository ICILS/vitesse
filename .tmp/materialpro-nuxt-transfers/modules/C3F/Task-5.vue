...
import DesignEditor from '../../../components/apps/design-editor/DesignEditor.vue'

const { t } = useI18n() // use as global scope
const task = ref({ title: t('task_5') })
// Item ID
const contentID = 'ModFloppyItemT5'
const nextTask = 'large-task/task-details'
...
<template>
  <v-row dense>
    ...
    >
      <BaseStimulusContentCard active-task-bar="taskbarDesignEditor">
        <DesignEditor />
