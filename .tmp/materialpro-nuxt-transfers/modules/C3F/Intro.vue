...
// import LottieConffetti from "../../../components/LottieConffetti.vue";
import Desktop from '../../../components/apps/desktop/Desktop.vue'
import ModFloppyData from './data/ModFloppyData'

const { t } = useI18n() // use as global scope
const task = ref({ title: t('sidenav.titles.introduction') })
// Item ID
// const contentID = "ModFloppyIntro";
    ...
    >
      <div class="pa-0">
        ...
        <BaseQuestionContentCard
          :header-tile="task.title" :header-bookmark="false" :header-help="true"
          :nav-next="nextTask" :action-bar-go-back="false"
        >
          <v-card-text class="dark:prose-light">
            <div class="mx-auto mt-8 prose prose-slate lg:prose-lg dark:prose-light dark:prose-light-blue">
              <p class="lead">
              ...
              <p>
                The <code>@tailwindcss/typography</code> plugin is our attempt to give you what you <em>actually</em>
                want, without any of the downsides of doing something stupid like disabling our base styles.
              </p>
              <p>
                It adds a new <code>prose</code> class that you can slap on any block of vanilla HTML content and turn
...
&lt;/article&gt;
              ...
              <p>
                What follows from here is just a bunch of absolute nonsense I've written to dogfood the plugin itself.
                It includes every sensible typographic element I could think of, like <strong>bold text</strong>,
              ...
              <p>
                Sometimes you have headings directly underneath each other. In those cases you often have to undo the
                top margin on the second heading because it usually looks better for the headings to be closer together
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    spacing between the paragraphs, list item heading, and separate list items to all make sense. Pretty
                    tough honestly, you could make a strong argument that you just shouldn't write this way.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    only had one item, and we really want this to look realistic. That's why I've added this second list
              ...
              <p>
                I think most people are going to use <a href="https://highlightjs.org/">highlight.js</a> or <a
                  href="https://prismjs.com/"
                >Prism</a> or something if they want to style their code blocks but it
  ...
  plugins: [],
              ...
              <p>
                I almost forgot to mention links, like <a href="https://tailwindcss.com">this link to the Tailwind CSS
              ...
              <p>
                But now we have. Please don't use <code>h5</code> or <code>h6</code> in your content, Medium only
              ...
              <p>
                We don't style them at all out of the box because <code>h4</code> elements are already so small that
    ...
    >
      <BaseStimulusContentCard :show-task-bar="false">
        <v-hover v-slot="{ isHovering, props }">
          <v-card class="mx-auto" max-width="100%" height="100%" v-bind="props">
            <Desktop />
