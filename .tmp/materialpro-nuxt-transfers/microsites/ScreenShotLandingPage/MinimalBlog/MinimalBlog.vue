...
<template>
  <div>
    <body
      class="bg-gray-100 font-sans leading-normal tracking-normal flex flex-col"
    >
      <!-- Container -->
...
&lt;/header&gt;
        ...
        <div class="container px-4">
          ...
          >
            ...
            <h3
              class="font-bold break-normal text-gray-600 text-sm md:text-base"
            >
        ...
        <div class="flex w-full items-center font-sans px-4 py-12">
          ...
          <div class="flex-1 px-2">
            <p class="text-base font-bold md:text-xl leading-none mb-2">
              Jo Bloggerson
            </p>
